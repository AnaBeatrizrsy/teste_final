...
class SiteController extends Controller
{
    public function index()
    {
        ...
        foreach ($publicacoes as $pub) {
            $pub->comentarios = DB::table('comentarios')
            ->join('usuario', 'comentarios.usuario_id', '=', 'usuario.id')
            ->where('comentarios.publicacao_id', $pub->id_publicacao)
            ->select('comentarios.texto', 'usuario.nome', 'comentarios.created_at')
